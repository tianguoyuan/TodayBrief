  ...
  <div class="px-4 flex flex-col min-h-[calc(100vh-3.5rem)] justify-center">
    <div class="p-6 rounded-2xl bg-white shadow-sm dark:bg-gray-800">
      <div class="mb-6 text-center">
        ...
        <h2 class="text-lg font-bold">欢迎回来</h2>
        <p class="text-xs text-gray-400 mt-1">登录今日快讯，开启资讯之旅</p>
      </div>
      ...
      <p class="text-xs text-gray-400 mt-4 text-center">演示应用：输入任意账号密码即可登录</p>
    </div>

    <p class="text-xs text-gray-400 mt-4 text-center">
      还没有账号？
      <RouterLink class="text-orange-500" to="/register">立即注册</RouterLink>
    </p>
  </div>
</template>
